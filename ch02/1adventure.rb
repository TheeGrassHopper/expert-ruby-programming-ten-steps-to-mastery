...
class Treasure < Thing      # Treasure descends from Thing
      def initialize( aName, aDescription, aValue )
          super( aName, aDescription, aValue )
          @value = aValue
      end
 ...
 # t1 = Treasure.new("FirstName: AL", "an Elvish weapon forged of gold",800)
...
ob = MyClass.new
puts ob.aMethod.inspect

puts MyClass.aClassMethod.inspect
